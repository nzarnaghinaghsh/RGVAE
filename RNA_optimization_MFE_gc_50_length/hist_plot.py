...
plt.title('Histogram of the MFE score of the generated sequences')
plt.savefig('MFE_SLF_len.png', dpi=500)
...
plt.xlabel('Values')
plt.ylabel('Frequency')
plt.title('Histogram of the GC-content of the generated sequences')
plt.savefig('GC_SLF_len.png', dpi=500)





fname = 'Whole_length_tt.txt'
...
plt.xlabel('Values')
plt.ylabel('Frequency')
plt.title('Histogram of the length of the generated sequences')
plt.savefig('len_SLF.png', dpi=500)





fname = 'generated_selected_results_just_MFE.txt'
...
plt.xlabel('Values')
plt.ylabel('Frequency')
plt.title('Histogram of the MFE of the generated sequences \n with the target GC-content of 50% and the length constraint.')
plt.savefig('MFE_gen_just_len_SLF.png', dpi=500)
